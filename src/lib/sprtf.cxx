 ...
 *
 *   Revision 1.0.3  2015/02/23 00:00:00  geoff
 *       Add export macro to include in a DLL (or static) library
...
static const char *def_log = "temp-test.txt";
#else
static const char *def_log = "temp-test.log";
#endif
char logfile[256] = "\0";
FILE * outfile = NULL;
